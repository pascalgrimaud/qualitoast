...
import io.github.pascalgrimaud.qualitoast.web.rest.errors.EmailAlreadyUsedException;
import io.github.pascalgrimaud.qualitoast.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public List<User> search(@PathVariable String query) {
        log.debug("REST request to search User: {}", query);
