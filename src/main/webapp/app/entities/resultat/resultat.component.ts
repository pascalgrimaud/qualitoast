...
currentAccount: any;
    ...
    trackId(index: number, item: Resultat) {
        return item.id;
    }
    registerChangeInResultats() {
        this.eventSubscriber = this.eventManager.subscribe('resultatListModification', (response) => this.loadAll());
    }
