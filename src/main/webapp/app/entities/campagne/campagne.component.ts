...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/campagne'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Campagne) {
        return item.id;
    }
    registerChangeInCampagnes() {
        this.eventSubscriber = this.eventManager.subscribe('campagneListModification', (response) => this.loadAll());
    }
