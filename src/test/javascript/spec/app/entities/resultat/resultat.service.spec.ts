...
describe('Service Tests', () => {
    ...
    describe('Resultat Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ResultatService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/resultats/' + 123);
            });
            it('should return Resultat', () => {

                let entity: Resultat;
                service.find(123).subscribe((_entity: Resultat) => {
                    entity = _entity;
                });
