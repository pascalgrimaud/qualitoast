...
describe('Service Tests', () => {
    ...
    describe('Campagne Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CampagneService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/campagnes/' + 123);
            });
            it('should return Campagne', () => {

                let entity: Campagne;
                service.find(123).subscribe((_entity: Campagne) => {
                    entity = _entity;
                });
